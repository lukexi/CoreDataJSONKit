...
@interface CouchDrawAppDelegate ()

@property (nonatomic, retain) CDDemoViewController *demoViewController;

@end

@implementation CouchDrawAppDelegate
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"CouchDraw" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"CouchDraw.sqlite"];
